...
public class ViewBookedHotel extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ViewBookedHotel frame = new ViewBookedHotel("mahek");
    ...
    public ViewBookedHotel(String username)  {
        ...
        lblName_1.setFont(new Font("Times New Roman", Font.BOLD, 20));
        ...
        lblCountry.setBounds(35, 270, 230, 14);
        ...
        lblReserveRoomNumber.setFont(new Font("Times New Roman", Font.BOLD, 20));
        ...
        lblCheckInStatus.setFont(new Font("Times New Roman", Font.BOLD, 20));
        ...
        lblDeposite.setFont(new Font("Times New Roman", Font.BOLD, 20));
        ...
        la2.setFont(new Font("Times New Roman", Font.BOLD, 20));
        contentPane.add(la2);
